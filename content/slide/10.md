...
* `!!` Expande para o último comando digitado. Uso comum: Depois do comando digitado, descobre-se que
  é preciso rodar o comando com `sudo`. Neste caso, basta usar `sudo !!` para repetir o comando. Pode
  ser usado diretamente para repetir o último comando.

* `!string` Expande para o comando mais recente contendo o string desejado. Ex: para repetir a última
  linha de compilação usando o gcc (supondo que uma exista no seu histórico): `!gcc`
